...
from .listing import guess_listing_type, parse_unix_perm, \
...
class TestListing(unittest.TestCase):
        ...
        self.assertEqual(
            [
                FileEntry('README', 'file', 531,
                          datetime_1, None, 0o644),
                FileEntry('etc', 'dir', 512,
                          date_factory(1994, 4, 8), None, 0o555),
                FileEntry('etc', 'dir', 512,
                          date_factory(1994, 4, 8), None, 0o555),
                FileEntry('bin', 'symlink', 7,
                          datetime_2, 'usr/bin', 0o777),
                FileEntry('blah', 'dir', 512,
                          date_factory(2004, 4, 8), None, 0o555),
            ],
            results
        )
        ...
        self.assertEqual(
            [
                FileEntry('licensed', 'dir', None,
                          date_factory(2000, 4, 27, 21, 9), None, None),
                FileEntry('pub', 'dir', None,
                          date_factory(2000, 7, 18, 10, 16), None, None),
                FileEntry('readme.htm', 'file', 589,
                          date_factory(2000, 4, 14, 15, 47), None, None),
            ],
            results
        )
    ...
    def test_parse_nlst(self):
        ...
        self.assertEqual(
            [
                FileEntry('horse.txt', None, None,
                          None, None, None),
                FileEntry('fish', None, None,
                          None, None, None),
                FileEntry('dolphin.jpg', None, None,
                          None, None, None),
                FileEntry('delicious cake.wri', None, None,
                          None, None, None),
                FileEntry('egg', None, None,
                          None, None, None),
            ],
            results
        )
        ...
        self.assertEqual(
            [
                FileEntry('2009-12', 'file', 1558532,
                          date_factory(2009, 12, 30), None, 0o644),
                FileEntry('2010-01', 'file', 10564020,
                          date_factory(2010, 1, 14), None, 0o644),
            ],
            results
        )
        ...
        self.assertEqual(
            [
                FileEntry('english_german.2010-03-24.tar.gz', 'file', 242408,
                          date_factory(2010, 3, 24), None, 0o644),
                FileEntry('old', 'dir', 4096,
                          date_factory(2010, 3, 24), None, 0o755),
            ],
            results
        )
